              ...
              <Row gutter={[16, 16]}>
                <Col sm={8}>
                  <Form.Item
                    label="Email"
                    name="hotelEmail"
                    initialValue={hotel?.hotel_email}
                    rules={rules.email}
                  >
                    <Input />
                  </Form.Item>
                ...
                <Col sm={8}>
                  <Form.Item
                    label="Số điện thoại"
                    name="hotelPhone"
                    initialValue={hotel?.hotel_phone}
                    rules={[
                      {
                        required: true,
                ...
                <Col sm={8}>
                  <Form.Item
                    initialValue={hotel?.hotel_address}
                    label="Địa chỉ"
                    rules={[
                      {
                        required: true,
