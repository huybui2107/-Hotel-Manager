...
const Register = () => {
  ...
  const onFinish = async (values) => {
    const { firstName, lastName, email, password ,username,birthday} = values;
    const data = { firstName, lastName, email, password ,username ,birthday};
    try {
      ...
      <Col xl={12}>
        <div className={styles.formContainer}>
          ...
          >
            ...
            <Form.Item
            label="Tên tài khoản " name="username" rules={rules.name} validateStatus="error"
            help={error || null}>
                <Input />
            </Form.Item>
